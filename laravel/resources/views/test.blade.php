    ...
    <form
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Idade inicial de carregamento
                </span>
                <span
                    name="symbol" class="input-group-text">t<sub>0</sub>
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                <span
                    name="units" class="input-group-text">(dias)
                </span>
                <span
                    id="info-tempo-zero" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-tempo-zero" data-toggle="tooltip" title="Momento em que começa o carregamento (normalmente retirada de escoramento)">?
                    </a>
                </span>
            </div>
            @error('t0')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Módulo de elasticidade inicial
                </span>
                <span
                    name="symbol" class="input-group-text">E<sub>ci</sub>
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                <span
                    name="units" class="input-group-text">(MPa)
                </span>
                <span
                    id="info-tensao-carregamento" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-tensao-carregamento" data-toggle="tooltip" title="Substitui tipo de agregado e resistência a tração nos cálculos">?
                    </a>
                </span>
            </div>
            @error('eci')
        ...
        <div class="input-group mb-0">
            ...
            <div class="input-group-append">
                <span
                    id="info-cimento" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-cimento" data-toggle="tooltip" title="Qualidade do cimento Portland">?
                    </a>
                </span>
            </div>
            @error('CP')
        ...
        <div class="input-group mb-0">
            ...
            <div class="input-group-append">
                <span
                    id="info-agregado" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-agregado" data-toggle="tooltip" title="Utilizado para calcular módulo de elasticidade inicial.">?
                    </a>
                </span>
            </div>
            @error('ag')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Resistência a tração
                </span>
                <span
                    name="symbol" class="input-group-text">f<sub>ct</sub>
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                ...
                <span
                    id="info-resistencia-t" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-resistencia-t" data-toggle="tooltip" title="Utilizado para calcular módulo de elasticidade inicial.">?
                    </a>
                </span>
            </div>
            @error('fct')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Resistência do concreto
                </span>
                <span
                    name="symbol" class="input-group-text">f<sub>ck</sub>
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                ...
                <span
                    id="info-resistencia" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-resistencia" data-toggle="tooltip" title="20MPa a 90MPa">?
                    </a>
                </span>
            </div>
            @error('fck')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Abatimento do concreto
                </span>
                <span
                    name="symbol" class="input-group-text">ab
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                <span
                    name="units" class="input-group-text">(cm)
                </span>
                <span
                    id="info-abatimento" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-abatimento" data-toggle="tooltip" title="Resistência característica do concreto obtida por ensaios da norma NBR NM 67.">?
                    </a>
                </span>
            </div>
            @error('ab')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Seção transversal da peça
                </span>
                <span
                    name="symbol" class="input-group-text">Ac
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                ...
                <span
                    id="info-area" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-area" data-toggle="tooltip" title="Área da seção transversal da peça.">?
                    </a>
                </span>
            </div>
            @error('Ac')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Perímetro em contato com o ar
                </span>
                <span
                    name="symbol" class="input-group-text">u<sub>ar</sub>
                </span>
            </div>
            <input
            ...
            <div class="input-group-append">
                ...
                <span
                    id="info-perimetro" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-perimetro" data-toggle="tooltip" title="Perímetro da seção em contato com a atmosfera.">?
                    </a>
                </span>
            </div>
            @error('uar')
        ...
        <div class="input-group mb-0">
            <div class="input-group-prepend">
                <span
                    name="description" class="input-group-text">Idade para cálculo da fluência
                </span>
                <span
                    name="symbol" class="input-group-text">t
                </span>
            </div>
            <input
                name="t" id="t" type="text" class="form-control {{!$errors->any() ? '' : ($errors->has('t') ? 'is-invalid' :'is-valid' )}}" value="{{old('t')}}">
            <div class="input-group-append">
                ...
                <span
                    id="info-tempo" class="input-group-text">
                    <a
                        class="badge badge-info" tabindex="-1" href="#info-tempo" data-toggle="tooltip" title=" Mínimo 7 dias - tempo para o cálculo da fluênca.">?
                    </a>
                </span>
            </div>
            @error('t')
        ...
        <div class="input-group mb-0">
            <button
                type="submit" class="btn btn-outline-info btn-calcular btn-block">Calcular
            </button>
        </div>
    </form>
    {{-- Começo do resultado --}}
