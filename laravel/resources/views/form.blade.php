...
@section('body')
    <div class="container">
        <form
            action="{{route('creep.calculus')}}#resposta" method="post" id="formFluencia">
            @csrf
            ...
            <div class="input-group">
                ...
                <select
                    name="CP" id="CP" class="custom-select {{!$errors->any() ? '' : ($errors->has('CP')?'is-invalid':'is-valid' )}}">
                    value="{{old('CP')}}">
            ...
            <div class="input-group">
                ...
                <select
                    name="ag" id="ag" class="custom-select {{!$errors->any() ? '' : ($errors->has('ag') ?'is-invalid':'is-valid' )}}">
                    value="{{old('ag')}}">
                    <option
            ...
            <div class="input-group mb-0">
                <button
                    type="submit" class="btn btn-calcular btn-block" id="calcular">Calcular
                </button>
            </div>
